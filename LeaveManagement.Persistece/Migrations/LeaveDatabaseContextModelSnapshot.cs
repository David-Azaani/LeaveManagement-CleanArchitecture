...
namespace LeaveManagement.Persistence.Migrations
{
    ...
    partial class LeaveDatabaseContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 7, 19, 9, 44, 14, 777, DateTimeKind.Local).AddTicks(3217),
                            DateModified = new DateTime(2023, 7, 19, 9, 44, 14, 777, DateTimeKind.Local).AddTicks(3229),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
